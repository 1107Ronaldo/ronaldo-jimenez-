...
datos_personales = []
datos_personales.append("RONALDO")
datos_personales.append(17) 
datos_personales.append(1.80) 
datos_personales.append("Soltero") 
datos_personales.append("CallE PLAYAS BLANCAS")
